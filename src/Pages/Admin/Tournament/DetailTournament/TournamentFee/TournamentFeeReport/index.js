...
function TournamentFeeReport({ tournament, tournamentStatus, value, index }) {
    ...
    const handleChangeType = (event) => {
        ...
        getReportPayment(tournamentId, event.target.value);
    };
    ...
    const columns = [
        ...
        { field: 'time', headerName: 'Thời gian', flex: 0.1 },
        {
            field: 'updatedBy',
        ...
        { field: 'fundBalance', headerName: 'Số dư', flex: 0.2 },
    ];
