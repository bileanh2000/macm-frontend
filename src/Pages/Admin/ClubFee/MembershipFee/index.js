            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={8}>
                    <Typography variant="h5" gutterBottom component="div" sx={{ fontWeight: 500, marginBottom: 2 }}>
                        Thời gian: Học kì Summer 2022
                        <Box sx={{ display: 'flex' }}>
                            <Typography variant='h6' sx={{ color: 'red', marginRight: 5 }}
                            >
                                Số tiền : {cost.toLocaleString('vi-VN', { style: 'currency', currency: 'VND', })}
                            </Typography>
                            <Button startIcon={<Edit />} onClick={() => handleEdit(cost)}>Chỉnh sửa phí</Button>
                        </Box>

                    </Typography>
                </Grid>
                <Grid item xs={4}>
                    <Typography variant='h6' sx={{ float: 'right' }}>Đã đóng: {attendance}/{userList.length}</Typography>
                </Grid>
            </Grid>
