...
function EventAttendance({ data }) {
    ...
    const checkAttendanceByEventId = async (id) => {
        try {
            const response = await adminAttendanceAPI.getAttendanceByEventId(id);
            console.log('checkAttendanceByEventId', response);
        ...
        return (
            <GridToolbarContainer sx={{ justifyContent: 'space-between' }}>
                ...
                <Typography variant="body1">
                    Số người tham gia: {totalActive}/{totalResult}
                </Typography>
    ...
    return (
        <Fragment>
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                <Button variant="contained" sx={{ mb: 2 }} component={Link} to="/admin/attendance">
                    Điểm danh
                </Button>
            </Box>
            <Box
